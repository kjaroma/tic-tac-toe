...
function BoardCell({ onCellClick, cellValue, winHighlight }: BoardCellProps) {
  ...
  return (
    <div className={`${winHighlight ? 'bg-green-900' : 'bg-gray-800'} ${winHighlight ? 'hover:bg-green-800' : 'bg-gray-800'} hover:bg-gray-700 text-gray-100 font-semibold w-24 h-24 border border-gray-900 rounded-lg shadow m-2 flex flex-col justify-center items-center`}
